...
path = r"C:\Users\mindf\Desktop\current-training\python\13_case_study\students.csv"
f = open(path, "r")
content = f.readlines()
f.close()
...
path = r"C:\Users\mindf\Desktop\current-training\python\13_case_study\result-updated.csv"
f = open(path, "w")
f.write(coldata)
for regid in classdict.keys():
